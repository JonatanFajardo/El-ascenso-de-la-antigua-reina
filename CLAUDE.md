# El Reino de los Osamentales

## ⚠️ GUÍAS NARRATIVAS PROFESIONALES

### 📁 **UBICACIÓN DE TÉCNICAS ESPECÍFICAS**
**Directorio**: `guias-narrativa/`

**Acceso rápido a guías especializadas:**
- `00-INDICE-GUIAS.md` - Índice completo de todas las técnicas
- `01-PALABRAS-DE-RELLENO.md` - Eliminación de texto redundante
- `02-REALISMO-PSICOLOGICO.md` - Comportamiento auténtico de personajes
- `03-DESCRIPCIONES-AMBIENTALES.md` - Inmersión específica y sensorial
- `04-TRANSICIONES-FLUIDAS.md` - Conexiones claras entre escenas
- `05-CLARIDAD-CONTEXTUAL.md` - Términos técnicos accesibles
- `06-DIVISION-PARRAFOS.md` - Párrafos con foco único

### 🎯 **APLICACIÓN OBLIGATORIA**
**SIEMPRE consultar las guías específicas** antes de generar o editar cualquier contenido narrativo.
